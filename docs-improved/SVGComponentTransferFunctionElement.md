# SVGComponentTransferFunctionElement API 兼容性数据
...
function isSVGComponentTransferFunctionElementSupported() {
    return 'SVGComponentTransferFunctionElement' in window || typeof SVGComponentTransferFunctionElement !== 'undefined';
}
