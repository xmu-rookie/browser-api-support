# NotificationEvent.NotificationEvent API 兼容性数据
...
```javascript
// NotificationEvent.NotificationEvent 使用示例
// 请查阅MDN文档了解具体用法
console.log('NotificationEvent.NotificationEvent API');
```
...
```javascript
// 检查NotificationEvent.NotificationEvent是否支持
function isNotificationEventNotificationEventSupported() {
    return 'NotificationEvent' in notificationevent && typeof notificationevent.NotificationEvent === 'function';
}

if (isNotificationEventNotificationEventSupported()) {
    console.log('NotificationEvent.NotificationEvent 支持');
    // 使用NotificationEvent.NotificationEvent
} else {
    console.log('NotificationEvent.NotificationEvent 不支持，需要polyfill');
    // 加载polyfill或使用替代方案
}
```
...
```javascript
// NotificationEvent.NotificationEvent polyfill
if (!notificationevent.NotificationEvent) {
    // 在这里添加polyfill实现
    console.log('加载NotificationEvent.NotificationEvent polyfill');
}
```
